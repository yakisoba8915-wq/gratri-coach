...
export default function PracticePage() {
  const [storedLogs] = useLocalData(localData.getLogs); const [storedTricks] = useLocalData(localData.getTricks); const logs=storedLogs??initialPracticeLogs; const tricks=storedTricks??initialTricks;
