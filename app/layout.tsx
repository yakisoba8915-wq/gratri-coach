...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="ja"><body className="font-sans"><AppOnboarding/><div className="mx-auto min-h-screen max-w-2xl px-4 pb-28 pt-5">{children}</div><BottomNav /></body></html>;
}
