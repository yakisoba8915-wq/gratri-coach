...
const normalizeTrickAccessType=(value:unknown):TrickAccessType=>value==="free"?"free":"premium";
const normalizePlanType=(value:unknown):PlanType=>value==="premium"||value==="admin"||value==="beta_tester"||value==="editor"?value:"free";
...
const weekOrder:Weekday[]=["月","火","水","木","金","土","日"];
...
export const dataRepository={
  async getTricks():Promise<Trick[]>{return (await loadAllTricks()).filter((trick)=>(trick.trickType??"snow")==="snow");},
  async getAllTricks():Promise<Trick[]>{return loadAllTricks();},
